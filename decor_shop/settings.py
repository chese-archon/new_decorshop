"""
Django settings for decor_shop project.
...
SECRET_KEY = 'django-insecure-(2++xxz8zsak41sz8ijb4&+b1mhg%ih0=9qa_6bq+tkcoq72ga'
...
WSGI_APPLICATION = 'decor_shop.wsgi.application'
